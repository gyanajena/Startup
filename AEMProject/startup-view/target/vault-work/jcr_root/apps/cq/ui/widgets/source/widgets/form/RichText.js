...
CQ.form.RichText = CQ.Ext.extend(CQ.Ext.form.Field, {
    ...
    /**
     * @cfg {Boolean} keepSourceEditMode
     * Flag that determines if source edit mode should be preserved when the dialog
     * containing the widget is reopened. Can be used to restore the behavior of CQ
     * prior to version 6.0. Defaults to false
     * @since 5.7
     */
    keepSourceEditMode: false,
                ...
                for (var t = 0; t < typeCnt; t++) {
                    ...
                    if (styles != null) {
                        ...
                        for (var s = 0; s < styleCnt; s++) {
                            ...
                            if (!com.arrayContains(cssToAdd, cssName)) {
